...
export default function ResumePage() {
  return (
    <div className="container flex flex-col items-center mx-auto mt-[50px] px-6 py-20">
      <h1 className="text-3xl md:text-4xl font-semibold text-center mb-4">Resume</h1>
      <p className="text-muted-foreground text-center mb-8">Below is my latest resume.</p>
      <Image
        src="/resume.svg"
        width={720}
        height={500}
